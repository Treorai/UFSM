...
# This script was generated Tue Nov 25 20:16:53 2025 by:
#
...
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1.lvsfile \
#	-rcxdir \
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1 \
#	-xy_coordinates c,r -type full -temperature 25.0 -tempdir \
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1/rcx_temp \
...
#	-output \
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1/extview.tmp \
...
#	-hcci_run_name tristatebuffer_x1 -hcci_run_dir \
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb \
...
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1.gds.map
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
##ADD_BULK_TERMINAL=N
##AGDS_FILE=/dev/null
##AGDS_LAYER_MAP_FILE=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1.gds.map
...
##HCCI_NET_PROP=5
##HCCI_RULE_FILE=
##HCCI_RUN_DIR=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb
##HCCI_RUN_NAME=tristatebuffer_x1
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1/tristatebuffer_x1.gnx,/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1/tristatebuffer_x1.gdx
##XY_COORDINATES=c,r
##=======================================================
...
setTempDir /home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1/rcx_temp
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1
...
agds2rcx -V -H satfile -r \
	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1/tristatebuffer_x1.xcn \
	-split_float_exclude_layers \
	ndiff_0conn,pdiff_0conn,nwell_0conn,psubstrate -crundir \
	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb \
	-unit meters -df2 -xgl -pl tristatebuffer_x1.ports -f \
	tristatebuffer_x1.alm -lnn tristatebuffer_x1.lnn -pnet 5 -pinst 6 \
	-pdev 7 tristatebuffer_x1.agf tristatebuffer_x1_pin_xy.spi
...
flattenLayers -m cont_0pdiff cont_0ndiff_metal1_0conn_ndiff_0conn
flattenLayers -m cont_0ndiff ptap
...
rex -V -m -pd -I'#' -tech \
	...
	res.mod np_rpoly_0conn::poly_conn_cut \
...
xreduce -V -mergecap -n NET -tech \
	...
	-e \
	metal11_conn,metal10_conn,metal9_conn,metal8_conn,metal7_conn,metal6_conn,metal5_conn,metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX,np_rndiff_0conn,np_rpdiff_0conn,np_rnwell_0conn,np_rpsubstrate,rVia1,rcont_0poly \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0 -cgnd ${CAP_GROUND},1.0 \
	-dxref \
	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1/tristatebuffer_x1.gdx \
	-nxref \
	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1/tristatebuffer_x1.gnx \
	...
	-rPmw res.mod np_rmetal2_0conn.res,Rnp_rmetal2_0conn.dev2 \
	np_rmetal1_0conn.res,Rnp_rmetal1_0conn.dev2 \
	np_rpoly_0conn.res,Rnp_rpoly_0conn.dev2 rVia1.res,RrVia1.dev2 \
...
ENDCAT
cat \
	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_tristatebuffer/svdb/tristatebuffer_x1/hccisavefile \
	>> _save_layers
