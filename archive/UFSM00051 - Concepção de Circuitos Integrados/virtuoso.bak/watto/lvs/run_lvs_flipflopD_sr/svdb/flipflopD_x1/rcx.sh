#!/home/tools/cadence/installs/QUANTUS231/tools.lnx86/extraction/bin/64bit/assura_rcx -V
# This script was generated Tue Nov 25 20:55:44 2025 by:
#
# Program: /home/tools/cadence/installs/QUANTUS231/tools.lnx86/extraction/bin/64bit/RCXspice
# Version: 23.1.1-p051
# Created: Thu Feb 15 21:11:17 PST 2024
#
#/home/tools/cadence/installs/QUANTUS231/tools.lnx86/extraction/bin/64bit/RCXspice \
#	-techdir \
#	/home/tools/design_kits/cadence/GPDK045/gpdk045_v_6_0/qrc/typical \
#	-corner rcx_typical -newlvs \
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1.lvsfile \
#	-rcxdir \
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1 \
#	-xy_coordinates c,r -type full -temperature 25.0 -tempdir \
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1/rcx_temp \
...
#	-output \
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1/extview.tmp \
...
#	-hcci_run_name flipflopD_x1 -hcci_run_dir \
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb \
...
#	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1.gds.map
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
##ADD_BULK_TERMINAL=N
##AGDS_FILE=/dev/null
##AGDS_LAYER_MAP_FILE=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1.gds.map
...
##HCCI_NET_PROP=5
##HCCI_RULE_FILE=
##HCCI_RUN_DIR=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb
##HCCI_RUN_NAME=flipflopD_x1
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1/flipflopD_x1.gnx,/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1/flipflopD_x1.gdx
##XY_COORDINATES=c,r
##=======================================================
...
setTempDir /home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1/rcx_temp
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1
...
agds2rcx -V -H satfile -r \
	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1/flipflopD_x1.xcn \
	-split_float_exclude_layers \
	ndiff_0conn,pdiff_0conn,nwell_0conn,psubstrate -crundir \
	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb \
	-unit meters -df2 -xgl -pl flipflopD_x1.ports -f flipflopD_x1.alm \
	-lnn flipflopD_x1.lnn -pnet 5 -pinst 6 -pdev 7 flipflopD_x1.agf \
	flipflopD_x1_pin_xy.spi
...
flattenLayers -m cont_0pdiff cont_0pdiff_metal1_0conn_pdiff_0conn _0pmos1v_orig
flattenLayers -m cont_0ndiff cont_0ndiff_metal1_0conn_ndiff_0conn
flattenLayers -m Via2 ptap
flattenLayers -m Via1 ntap
...
mergevia -V -tech \
	/home/tools/design_kits/cadence/GPDK045/gpdk045_v_6_0/qrc/typical \
	-cnt np_rVia1 rVia1 - np_rmetal2_0conn np_rmetal1_0conn
cp rVia1 rVia1_orig
mergevia -V -tech \
	/home/tools/design_kits/cadence/GPDK045/gpdk045_v_6_0/qrc/typical \
	-cnt np_rVia2 rVia2 - np_rmetal3_0conn np_rmetal2_0conn
cp rVia2 rVia2_orig
mergevia -V -tech \
	/home/tools/design_kits/cadence/GPDK045/gpdk045_v_6_0/qrc/typical \
...
connect -V -relocate NET np_rndiff_0conn:np_rndiff_0conn.conn \
	...
	np_rpsubstrate:np_rpsubstrate.conn rVia1 rVia2 rcont_0poly \
	_0nmos1v_mgvia _0pmos1v_mgvia - ntap,1,3 ptap,2,4 -
...
rex -V -m -pd -I'#' -tech \
	/home/tools/design_kits/cadence/GPDK045/gpdk045_v_6_0/qrc/typical \
	-map p2elayermapfile -wee p2elayermapfile -N NET -e2 -Ply \
	np_rpoly_0conn -er \
	np_rmetal3_0conn,metal3_conn.den:np_rmetal2_0conn,metal2_conn.den:np_rmetal1_0conn,metal1_conn.den \
	-rP res.mod np_rpoly_0conn::poly_conn_cut \
	np_rmetal1_0conn::metal1_conn_cut np_rmetal2_0conn::metal2_conn_cut \
	np_rmetal3_0conn::metal3_conn_cut - rVia1,2,3,t rVia2,3,4,t \
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R metal5_conn -b \
	metal2_conn,metal1_conn,poly_conn,Oxide,FOX -t \
	metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
	-Maxw 1.8 -p metal3_conn:metal3_conn_cut,key,metal5_conn,key 0,1.75,0 \
	- metal3_conn_metal5_conn.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b \
	metal2_conn,metal1_conn,poly_conn,Oxide,FOX -t \
	metal5_conn,metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
	-Maxw 1.8 -p metal3_conn:metal3_conn_cut,key,metal4_conn,key 0,1.75,0 \
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R metal4_conn -b \
	...
	metal2_conn:metal2_conn_cut,key,metal4_conn,key 0,1.75,0 - \
...
sw3d -V -cgnd ${CAP_GROUND} -sub 2 -b \
	metal2_conn,metal1_conn,poly_conn,Oxide,FOX -t \
	metal5_conn,metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
	-p metal3_conn:metal3_conn_cut,metal4_conn - \
...
pax16 -V -lee_off -delete_unused_files rm_files_in_pax16 -gnd ${CAP_GROUND} \
	...
	/home/tools/design_kits/cadence/GPDK045/gpdk045_v_6_0/qrc/typical/qrcTechFile \
	-f FOX Oxide poly_conn:poly_conn_cut metal1_conn:metal1_conn_cut \
	metal2_conn:metal2_conn_cut metal3_conn:metal3_conn_cut metal4_conn \
	metal5_conn metal6_conn metal7_conn metal8_conn metal9_conn \
	metal10_conn metal11_conn allGate - \
	/home/tools/design_kits/cadence/GPDK045/gpdk045_v_6_0/qrc/typical/qrcTechFile \
	- - NET - capfile
...
xreduce -V -mergecap -n NET -tech \
	/home/tools/design_kits/cadence/GPDK045/gpdk045_v_6_0/qrc/typical -d1 \
	-e \
	metal11_conn,metal10_conn,metal9_conn,metal8_conn,metal7_conn,metal6_conn,metal5_conn,metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX,np_rndiff_0conn,np_rpdiff_0conn,np_rnwell_0conn,np_rpsubstrate,rVia1,rVia2,rcont_0poly \
	-decoupled -sr -danglingR -minR 0.001 -rPvia \
	rVia2.res,rVia1.res,rcont_0poly.res,rcont_0pdiff_metal1_0conn_pdiff_0conn.res,rcont_0ndiff_metal1_0conn_ndiff_0conn.res \
	-rP \
	np_rpoly_0conn.res,np_rmetal1_0conn.res,np_rmetal2_0conn.res,np_rmetal3_0conn.res,mwires.res \
	-cap capfile L1T0 L2T0 _0nmos1v.transr _0pmos1v.transr

#==========================================================#
# Generate HSPICE file
#==========================================================#

advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0 -cgnd ${CAP_GROUND},1.0 \
	-dxref \
	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1/flipflopD_x1.gdx \
	-nxref \
	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1/flipflopD_x1.gnx \
	...
	-rPmw res.mod np_rmetal3_0conn.res,Rnp_rmetal3_0conn.dev2 \
	np_rmetal2_0conn.res,Rnp_rmetal2_0conn.dev2 \
	np_rmetal1_0conn.res,Rnp_rmetal1_0conn.dev2 \
	np_rpoly_0conn.res,Rnp_rpoly_0conn.dev2 rVia2.res,RrVia2.dev2 \
	rVia1.res,RrVia1.dev2 rcont_0poly.res,Rrcont_0poly.dev2 \
...
ENDCAT
cat \
	/home/ufsm00051/wagner.chitto/wagner.chitto/run_lvs_flipflopD/svdb/flipflopD_x1/hccisavefile \
	>> _save_layers
